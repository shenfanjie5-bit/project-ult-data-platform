"""Smoke tests — minimal end-to-end exercise of data-platform public entrypoints.

Path ``make smoke`` runs and assembly hits during stage public_smoke_probes
of bootstrap. Stays infra-free.
"""
